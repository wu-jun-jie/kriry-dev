...
- [The Reference](https://doc.rust-lang.org/reference/index.html) - [中文版《Rust语言参考》](https://rustlang-cn.org/office/rust/reference/)
...
- [The Discovery Book](https://rust-embedded.github.io/discovery/)
- [The Embedonomicon Book](https://docs.rust-embedded.org/embedonomicon/)

## Rust用户书录

- [The Book-学习心得](/users/book-exp/)
