...
## HTP帧层(HTTP Framing Layer) {#http-framing-layer}
...
## 请求取消与拒绝(Request Cancellation and Rejection)
...
`Example of Priority Tree Pruning`
...
## HTTP/3的扩展(Extensions to HTTP/3)
...
## HTTP/2设置参数(HTTP/2 SETTINGS Parameters)
