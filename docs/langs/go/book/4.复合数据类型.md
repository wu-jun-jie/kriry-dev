...
![An HTML table of go project issues relating to JSON encoding](https://docs.ruanjiadeng.com/gopl-zh/images/ch4-04.png)
...
![HTML metacharacters in issue title are correctly displayed](https://docs.ruanjiadeng.com/gopl-zh/images/ch4-05.png)
...
![string values are HTML-escaped but template.HTML values are not](https://docs.ruanjiadeng.com/gopl-zh/images/ch4-06.png)
